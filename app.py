...
@app.route('/review-1')
def review_1():
    return render_template('review-1.php')
@app.route('/review-2')
def review_2():
...
def top_sentences():
    ...
    outF = open("C:/Users/HOME/Desktop/f1/effective_doc.txt", "w+")
    for line in effective:
      # write line to output file
      outF.write(line)
      outF.write("\n")
    outF.close()
    with open("C:/Users/HOME/Desktop/f1/effective_doc.txt") as f:
        document = f.read()
    ...
    for index, row in reviews.iterrows():
        ...
        if (row['Category']=='Adverse'):
            adverse.append(str)
    outF = open("C:/Users/HOME/Desktop/f1/adverse_doc.txt", "w+")
    for line in adverse:
      # write line to output file
      outF.write(line)
      outF.write("\n")
    outF.close()
    with open("C:/Users/HOME/Desktop/f1/adverse_doc.txt") as f:
        document = f.read()
        document = ' '.join(document.strip().split('\n'))
        from nltk.tokenize.punkt import PunktSentenceTokenizer
        sentence_tokenizer = PunktSentenceTokenizer()
    ...
    outF = open("C:/Users/HOME/Desktop/f1/ineffective_doc.txt", "w+")
    for line in ineffective:
      # write line to output file
      outF.write(line)
      outF.write("\n")
    outF.close()
    with open("C:/Users/HOME/Desktop/f1/ineffective_doc.txt") as f:
        document = f.read()
        document = ' '.join(document.strip().split('\n'))
        from nltk.tokenize.punkt import PunktSentenceTokenizer
        sentence_tokenizer = PunktSentenceTokenizer()
...
def cons(your_list_effective,your_list_adverse,your_list_ineffective,scores_eff,scores_adr,scores_ineff,lgt):
    import pandas as pd
    dictionary=pd.read_csv('C:/Users/HOME/Downloads/ADR_lexicon - ADR_lexicon.csv', header = None)
    with open('C:/Users/HOME/Desktop/f1/adverse_doc.txt') as f:
        document = f.read()
